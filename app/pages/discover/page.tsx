...
// Travel options data
const travelOptions = [
  { name: "Backpacking", image: "/backpacking.jpg", link: "/pages/discover/backpacking" },
  { name: "Solo Travelling", image: "/solo-travel.jpg", link: "/pages/discover/solo-travelling" },
  { name: "Cultural Travelling", image: "/cultural.jpg", link: "/pages/discover/cultural-travelling" },
  { name: "Budget Travel", image: "/budget-travel.jpg", link: "/pages/discover/budget-travel" },
  { name: "Adventure Travel", image: "/adventure.jpg", link: "/pages/discover/adventure-travel" },
  { name: "Family Travel", image: "/family-travel.jpg", link: "/pages/discover/family-travel" },
  { name: "Luxury Travel", image: "/luxury.jpg", link: "/pages/discover/luxury-travel" },
];
  ...
  return (
    <section className="bg-gradient-to-br from-gray-100 via-blue-50 to-white py-16 text-gray-800">
      <div className="max-container padding-container">
        <h1 className="text-center bold-40 lg:bold-64 mb-12 text-gray-900">Discover New Destinations</h1>
